...
const Projects = () => {
    ...
    return (
        <div className="mt-20 border-b border-neutral-800 min-h-[800px]" id="projects">
                ...
                {projects.map((project, index) => (
                    <div className="flex flex-wrap justify-center gap-12 mb-12 min-h-72 border-b pb-12 w-100" key={index}>
                        ...
                        <span className='float-end text-green-600 border border-green-600 rounded-xl px-2'>{project.category}</span>
                            ...
                            <div className='flex flex-wrap justify-end mt-6 my-2'>
                            ...
                            <div className='flex justify-start mt-6 my-2'>
                                ...
                                <a className="mx-6 bg-gradient-to-r from-cyan-500 via-cyan-600 to-blue-800 py-2 px-3 hover:bg-gradient-to-bl rounded-2xl text-white" href={project.demoLink}>Demo</a>
